...
Scenario: Register new user and try login/logout
  ...
  Then User registered in database as 'Registration.User(email=user1@mail.com, id=<PLAYER_ID>, githubUsername=Stiven Pupkin, approved=1, code=<CODE>, data=Moon|Java|Home|10 years)'
