...
<body style="display:none;">
    ...
    <div id="settings" page="${page}" authenticated="${authenticated}" contextPath="${ctx}" game="${game}" room="${room}" playerId="${playerId}" githubUsername="${githubUsername}" code="${code}" allPlayersScreen="${allPlayersScreen}"></div>
